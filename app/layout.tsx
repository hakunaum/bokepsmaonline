...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepsmaonline.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'iM5YcojOTOwRCjonAE35MqvSWBPJk-jb3iLt0Z9Aa64',
        yandex: 'eb665cf70f88f907',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepsmaonline.pages.dev/?q={search_term}", 
